<section class="col-md-4 thumbnail">
  ...
  <form action="index.php?op=createProduct" method="post">
    <input class="form-control" type="number" name="product_id" placeholder="Product ID"><br>
    ...
    <input class="form-control" type="text" name="product_price" step="0,01" placeholder="Product prijs"><br>
